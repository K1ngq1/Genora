export const ERROR_MESSAGES_ZH = {
  ...
  APIMART_MISSING_TASK_ID: "APIMart 未返回任务 ID",
  APIMART_UPLOAD_FAILED: "参考图片上传到 APIMart 失败",
  APIMART_TASK_FAILED: "APIMart 生成任务失败",
  APIMART_RESULT_MISSING: "APIMart 任务已完成但未返回结果地址",
  UNSUPPORTED_MODEL_OPTIONS: "当前模型不支持所选参数或参考素材组合",
